  ...
  const founders = [
    {
      ...
      tagline: "Visionary leader bridging African innovation with global markets",
  ...
  const journeyMilestones = [
    {
      ...
      title: "The Spark",
      icon: "Lightbulb",
      description: "Alexius and Jerome meet at a Lagos tech meetup, bonding over shared frustration with technology that doesn't serve African communities effectively.",
      achievements: [
      ...
      impact: "Realized that accessible technology could transform entire communities",
      isHighlight: true
    },
    {
      year: "2020",
      ...
      icon: "Building",
      description: "Officially founded Develix during the pandemic, focusing on digital solutions that work even with limited infrastructure.",
      achievements: [
    ...
    },
    {
      ...
      icon: "Trophy",
      description: "Launched our first commercial product, gaining traction across West Africa and attracting international attention.",
      achievements: [
    ...
    },
    {
      ...
      icon: "Users",
      description: "Grew from 2 founders to a team of 12, bringing together diverse talents from across Nigeria and beyond.",
      achievements: [
    ...
    },
    {
      ...
      icon: "Zap",
      description: "Pivoted to focus on AI and blockchain solutions, beginning development of Elixa Coin and advanced AI tools.",
      achievements: [
    ...
    },
    {
      ...
      icon: "Globe",
      description: "Achieved international recognition while staying true to our African roots and community-first approach.",
      achievements: [
        "Elixa Coin beta launch with 1,200+ users",
        "Vendra marketplace platform development",
        "Expanded to serve clients in 12 countries"
      ],
      impact: "Demonstrated that African innovation can lead global conversations"
    }
  ];
  ...
  const cultureValues = [
    {
      ...
      description: "We don't build technology for the sake of technology. Every solution we create must solve real problems and improve real lives.",
      examples: [
    ...
    },
    {
      ...
      description: "Our success is measured by the positive impact we have on the communities we serve, not just our revenue numbers.",
      examples: [
    ...
    },
    {
      ...
      description: "We believe in open communication about our successes, failures, and everything in between.",
      examples: [
      ...
      quote: "Trust is built through consistent transparency, not perfect performance.",
    ...
    },
    {
      ...
      description: "We strive for world-class quality while remaining humble and always ready to learn from others.",
      examples: [
  ...
  const teamMembers = [
    {
      ...
      background: "Former design lead at Andela, passionate about creating intuitive interfaces that work across diverse user contexts and technical constraints.",
      skills: ["UI/UX Design", "User Research", "Accessibility", "Design Systems"],
      contribution: "Led the design of Elixa Coin's user interface, achieving 94% user satisfaction in beta testing.",
      funFact: "Speaks 4 Nigerian languages and uses this linguistic diversity to inform inclusive design decisions."
    },
    {
      name: "Kemi Adeleke",
      ...
      background: "Previously at Microsoft Azure, specializing in distributed systems and blockchain infrastructure. Returned to Nigeria to contribute to local tech ecosystem.",
      skills: ["Node.js", "Blockchain", "Cloud Architecture", "API Design"],
      contribution: "Architected the scalable backend infrastructure that powers all Develix platforms with 99.9% uptime.",
      funFact: "Maintains a popular tech blog in Yoruba, making complex programming concepts accessible to local developers."
    },
    {
      name: "David Okonkwo",
      ...
      background: "PhD in Machine Learning from University of Nigeria, Nsukka. Focused on developing AI models that work effectively with limited computational resources.",
      skills: ["Machine Learning", "NLP", "Computer Vision", "Edge Computing"],
      contribution: "Developed lightweight AI models that run efficiently on mobile devices, enabling AI access in low-resource environments.",
      funFact: "Grew up in a rural village without electricity and now builds AI systems - living proof of technology\'s transformative power."
    },
    {
      name: "Fatima Hassan",
      ...
      background: "Former journalist and community organizer, passionate about bridging the gap between technology and everyday users across Northern Nigeria.",
      skills: ["Community Building", "Content Strategy", "Public Speaking", "Cultural Translation"],
      contribution: "Built and manages our 5,000+ member developer community, with 85% active monthly participation.",
      funFact: "Organizes monthly 'Tech in Hausa' workshops, making programming concepts accessible in local languages."
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        ...
        <meta name="description" content="Meet the founders and team behind Develix. Learn about our culture, mission, and commitment to making advanced technology accessible across Africa." />
        <meta name="keywords" content="Develix founders, company culture, African tech, startup story, transparency, mission" />
      </Helmet>
      <Header />
      {/* Hero Section */}
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground font-inter max-w-4xl mx-auto leading-relaxed">
              The people, values, and vision behind Develix. Learn about our journey from a Lagos tech meetup to building Africa's premier AI-first technology company, and meet the team making it happen.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground font-inter max-w-3xl mx-auto">
              Two passionate technologists united by a shared vision of making advanced technology accessible across Africa and beyond.
            </p>
          </div>
      ...
      <section id="journey" className="py-16 bg-muted/30">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground font-inter max-w-3xl mx-auto">
              From a chance meeting at a Lagos tech meetup to building one of Africa's most promising technology companies.
            </p>
          </div>
      ...
      <section id="culture" className="py-16">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground font-inter max-w-3xl mx-auto">
              The values and principles that guide everything we do, from product decisions to community relationships.
            </p>
          </div>
      ...
      <section id="team" className="py-16 bg-muted/30">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground font-inter max-w-3xl mx-auto">
              Meet some of the talented individuals who bring diverse backgrounds and shared commitment to African tech advancement.
            </p>
          </div>
      ...
      <section className="py-16 bg-gradient-to-br from-primary to-secondary">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-primary-foreground/90 font-inter mb-8 leading-relaxed">
            Whether you're a potential partner, team member, or simply someone who believes in our mission, we'd love to connect with you.
          </p>
          
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="/contact-partnerships-multi-engagement-hub"
            ...
            <a
              href="/projects-hub-technical-showcase-vision"

  ...
  const commitments = [
    {
      ...
      description:
        "Quarterly progress reports covering product development, financial health, and community impact.",
    ...
    },
    {
      ...
      description:
        "Open sharing of funding rounds, revenue metrics, and how we allocate resources.",
    ...
    },
    {
      ...
      description:
        "Honest discussions about obstacles we face and how we're addressing them.",
      frequency: "As needed",
    },
    {
      icon: "Users",
      ...
      description:
        "Regular communication with our user base about product changes and company direction.",
      frequency: "Monthly",
    },
  ];
    ...
    <div className="space-y-12">
      ...
      >
        {commitments?.map((commitment, index) => (
          <motion.div
            key={index}
            className="bg-card rounded-xl p-6 brand-shadow-card brand-transition brand-hover-lift"
            variants={{
      ...
      >
        ...
        <div className="space-y-6">
          ...
          >
            ...
            >
              ...
              <div className="space-y-3">
                {reports?.[activeReport]?.highlights?.map(
                  (highlight, index) => (
                    <div
                      key={index}
            ...
            >
              ...
              <div className="space-y-3">
                {reports?.[activeReport]?.challenges?.map(
                  (challenge, index) => (
                    <div
                      key={index}
          ...
          >
            {Object.entries(reports?.[activeReport]?.metrics)?.map(
              ([key, value], index) => (
                <motion.div
                  key={index}
                  className="space-y-1"
      ...
      <motion.div
        className="text-center bg-gradient-to-r from-primary/5 to-secondary/5 rounded-xl p-8"
        initial={{ opacity: 0 }}
      ...
      >
        ...
        <p className="text-muted-foreground font-inter mb-4">
          We're always happy to provide more details about our operations,

  ...
  const inquiryTypes = [
    {
      ...
      description: "Custom AI & software development",
    },
    {
      value: "partnership",
    ...
    },
    {
      ...
      description: "Funding and strategic partnerships",
    },
    {
      value: "media",
      label: "Media & Press",
    ...
    },
    {
      ...
      description: "API access and community",
    },
    {
      value: "general",
    ...
    <section className="py-20 bg-surface">
      <div className="max-w-4xl mx-auto px-6 lg:px-8">
        ...
        <motion.div
          ...
          viewport={{ once: true, amount: 0.3 }} // 👈 fires only when visible
        >
          <h2 className="font-space-grotesk text-3xl md:text-4xl font-bold text-foreground mb-4">
            Get in Touch
          </h2>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Fill out the form below and we'll get back to you within our
            guaranteed response time. All fields marked with * are required.
          </p>
        </motion.div>

        {/* Form Container */}
        <motion.div
          className="bg-card rounded-2xl brand-shadow-card p-8"
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-success/80 mt-1">
                    We'll respond within {getResponseTime()}. Check your email
                    for confirmation.
                  </p>
                </div>
              </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="pt-6">
              ...
              <p className="text-xs text-muted-foreground text-center mt-3">
                ...
                respond within {getResponseTime()} during business hours.
              </p>
            </div>
          </form>
        </motion.div>

  ...
  const updates = [
    {
      ...
      excerpt:
        "Major breakthrough in our mobile wallet architecture. The new security layer is now 40% faster while maintaining bank-level encryption.",
    ...
    },
    {
      ...
      avatar:
        "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&h=100&fit=crop&crop=face",
      excerpt:
        "Our beta testers are loving Vendra's natural language processing. 94% satisfaction rate and some incredible use cases emerging.",
    ...
    },
    {
      ...
      avatar:
        "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&h=100&fit=crop&crop=face",
      excerpt:
        "Why we're building technology that works for African realities - from intermittent internet to diverse payment preferences.",
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Get behind-the-scenes insights from our CTO Jerome as he shares the
            journey of building AI-powered apps for Africa
          </p>
        </motion.div>

  ...
  const heroSlides = [
    {
      ...
      subtitle: "Experience the future of technology with apps that understand African contexts, work on any device, and solve real problems in your daily life.",
    ...
    },
    {
      ...
      subtitle: "The first cryptocurrency wallet designed specifically for Africans. Send money across borders, pay bills, and manage your digital assets with ease.",
    ...
    },
    {
      ...
      subtitle: "An AI assistant that speaks your language, understands your culture, and helps automate your business and personal tasks effortlessly.",
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <div className="relative">
              ...
              <div className="absolute -top-4 -left-4 bg-card rounded-lg border border-border p-4 brand-shadow-card animate-bounce">
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    <div className="text-sm font-semibold text-foreground">Beta Ready</div>
                    <div className="text-xs text-muted-foreground">Testing Phase</div>
                  </div>
                </div>
              </div>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-card/50 backdrop-blur-sm rounded-xl border border-border p-6 text-center brand-shadow-card brand-hover-lift">
            ...
            <p className="text-sm text-muted-foreground">Optimized for African mobile networks and devices</p>
          </div>
          ...
          <div className="bg-card/50 backdrop-blur-sm rounded-xl border border-border p-6 text-center brand-shadow-card brand-hover-lift">
            ...
            <h3 className="font-semibold text-foreground mb-2">Local Languages</h3>
            <p className="text-sm text-muted-foreground">Supports English, Pidgin, and major Nigerian languages</p>
          </div>
          ...
          <div className="bg-card/50 backdrop-blur-sm rounded-xl border border-border p-6 text-center brand-shadow-card brand-hover-lift">
            ...
            <p className="text-sm text-muted-foreground">Designed to work efficiently on limited data plans</p>
          </div>
        </div>
      </div>
    </div>

...
const ProjectsHub = () => {
  ...
  const projects = [
    {
      ...
      type: 'Blockchain',
      status: 'Live',
      description: 'Revolutionary blockchain platform enabling seamless cryptocurrency transactions with advanced smart contract capabilities and DeFi integration.',
      ...
      techStack: ['Solidity', 'React', 'Node.js', 'Web3.js', 'IPFS', 'PostgreSQL'],
      users: '25,000+',
      uptime: '99.9%',
      launchDate: 'Jan 2024',
      ...
      performance: {
        metrics: [
          { value: '3,000', label: 'TPS', description: 'Transactions per second' },
          { value: '< 3s', label: 'Finality', description: 'Transaction confirmation' },
          { value: '99.9%', label: 'Uptime', description: 'Network availability' },
          { value: '$0.001', label: 'Gas Fee', description: 'Average transaction cost' }
        ],
        loadTesting: [
          { scenario: 'Peak Load', result: '2,850 TPS', metric: 'Sustained throughput' },
          { scenario: 'Stress Test', result: '4,200 TPS', metric: 'Maximum capacity' },
          { scenario: 'Endurance', result: '24 hours', metric: 'Continuous operation' }
        ],
        optimizations: [
          {
      ...
      demos: [
        {
          ...
          description: 'Experience the user-friendly wallet interface with real-time balance updates',
          icon: 'Wallet',
          type: 'interactive',
        ...
        },
        {
          ...
          description: 'Explore automated smart contract execution and DeFi features',
          icon: 'Code',
          type: 'video',
      ...
      timeline: [
        {
          ...
          status: 'Completed',
          progress: 100,
          description: 'Initial concept development, market research, and technical architecture planning.',
          achievements: [
          ...
          challenges: [
            {
              ...
              solution: 'Chose Proof-of-Stake after extensive research and testing'
            }
          ],
          insights: [
            {
              author: 'Alexius',
              role: 'CEO',
              quote: 'The planning phase taught us the importance of thorough market research before diving into development.'
            }
          ],
          metrics: [
        ...
        },
        {
          ...
          status: 'Completed',
          progress: 100,
          description: 'Core blockchain development, smart contract creation, and frontend interface building.',
          achievements: [
          ...
          challenges: [
            {
              ...
              solution: 'Implemented sharding and optimized consensus algorithm'
            },
            {
          ...
          insights: [
            {
              author: 'Jerome',
              role: 'CTO',
              quote: 'Building a blockchain from scratch taught us invaluable lessons about distributed systems and consensus mechanisms.'
            }
          ],
          metrics: [
        ...
        },
        {
          ...
          status: 'Completed',
          progress: 100,
          description: 'Comprehensive testing including security audits, performance testing, and user acceptance testing.',
          achievements: [
          ...
          insights: [
            {
              author: 'Sarah',
              role: 'QA Lead',
              quote: 'Thorough testing revealed edge cases we never considered, making the platform much more robust.'
            }
          ],
          metrics: [
        ...
        },
        {
          ...
          status: 'Completed',
          progress: 100,
          description: 'Production deployment, monitoring setup, and initial user onboarding.',
          achievements: [
        ...
        },
        {
          ...
          status: 'In-Progress',
          progress: 85,
          description: 'Ongoing maintenance, feature updates, and community support.',
          achievements: [
    ...
    {
      id: 'vendra-ai',name: 'Vendra AI',type: 'AI Platform',status: 'Beta',description: 'Advanced AI-powered automation platform that streamlines business processes with intelligent workflows and machine learning capabilities.',
      ...
      performance: {
        metrics: [
          { value: '250ms', label: 'Response Time', description: 'Average API response' },
          { value: '95%', label: 'Accuracy', description: 'AI model accuracy' },
          { value: '99.8%', label: 'Uptime', description: 'Service availability' },
          { value: '10K', label: 'Requests/min', description: 'Peak throughput' }
        ],
        loadTesting: [
          { scenario: 'AI Inference', result: '8,500 req/min', metric: 'Sustained throughput' },
          { scenario: 'Data Processing', result: '1.2M records/hour', metric: 'Batch processing' },
          { scenario: 'Concurrent Users', result: '5,000 users', metric: 'Simultaneous sessions' }
        ],
        optimizations: [
          {
      ...
      demos: [
        {
          title: 'AI Assistant',
          description: 'Experience intelligent conversation and task automation',
          icon: 'MessageSquare',
          type: 'interactive',
      ...
      timeline: [
        {
          ...
          status: 'Completed',
          progress: 100,
          description: 'AI strategy development and technical architecture planning.',
          achievements: [
      ...
      testimonials: [
        ...
        {
          name: 'Sarah Johnson',role: 'Small Business Owner',company: 'Johnson Retail',userType: 'Individual',avatar: 'https://randomuser.me/api/portraits/women/42.jpg',
    ...
    {
      id: 'fintech-suite',name: 'FinTech Suite',type: 'Fintech',status: 'Development',description: 'Comprehensive financial technology platform offering payment processing, digital banking, and financial analytics solutions.',image: 'https://images.unsplash.com/photo-1563013544-824ae1b704d3?w=800&h=600&fit=crop',
      techStack: ['React', 'Node.js', 'MongoDB', 'Stripe', 'Plaid', 'Docker'],
      users: '5,000+',uptime: '99.5%',launchDate: 'Q2 2025',
      keyFeatures: [
        'Payment Processing','Digital Wallet','Financial Analytics','Fraud Detection','Compliance Tools','API Integration'
      ],
      timeline: [
        {
          phase: 'Planning',startDate: 'Oct 2024',endDate: 'Dec 2024',status: 'Completed',progress: 100,description: 'Financial services strategy and regulatory compliance planning.',
          metrics: [
        ...
        {
          phase: 'Development',startDate: 'Jan 2025',endDate: 'Apr 2025',status: 'In-Progress',progress: 45,description: 'Core platform development and payment integration.',
          metrics: [
      ...
      totalDuration: '8 months',teamSize: '12 members',milestonesCompleted: '8',
      overallProgress: 45,
      testimonials: [
        {
          name: 'Adebola Fashola',role: 'Financial Director',company: 'Growth Capital',userType: 'Enterprise',avatar: 'https://randomuser.me/api/portraits/men/45.jpg',content: `Even in development, the FinTech Suite shows incredible promise. The team's attention to regulatory compliance and security gives us confidence in the final product.`,
          rating: 4
        }
      ],
      testimonialStats: {
  ...
  const filters = [
    ...
    { id: 'blockchain', label: 'Blockchain', count: projects?.filter(p => p?.type === 'Blockchain')?.length },
    { id: 'ai', label: 'AI Platform', count: projects?.filter(p => p?.type === 'AI Platform')?.length },
    { id: 'fintech', label: 'FinTech', count: projects?.filter(p => p?.type === 'Fintech')?.length }
  ];

  const filteredProjects = activeFilter === 'all' 
    ? projects 
    : projects?.filter(project => project?.type?.toLowerCase()?.includes(activeFilter?.toLowerCase()));
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        ...
        <meta name="description" content="Explore Develix's flagship projects including Elixa Coin blockchain platform and Vendra AI automation suite. Detailed technical breakdowns, live demos, and development insights." />
        <meta name="keywords" content="Develix projects, Elixa Coin, Vendra AI, blockchain, artificial intelligence, technical showcase, Nigerian tech" />
      </Helmet>
      <Header />
      {/* Hero Section */}
      <ProjectHero />
      ...
      <main className="max-w-7xl mx-auto px-6 lg:px-8 py-16 space-y-16">
        ...
        <section className="space-y-8">
          <div className="text-center space-y-4">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Discover our innovative solutions across blockchain, AI, and fintech with detailed technical insights and live demonstrations.
            </p>
          </div>
        ...
        <section className="space-y-12">
          <div className="text-center space-y-4">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Get an in-depth look at {featuredProject?.name} with comprehensive technical specifications, live demos, and development insights.
            </p>
          </div>
        ...
        <section className="space-y-8">
          <div className="text-center space-y-4">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Explore our ambitious roadmap for the next year, featuring exciting new projects and major platform enhancements.
            </p>
          </div>
        ...
        <section className="text-center space-y-8 py-16">
          <div className="space-y-4">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Join us in creating innovative solutions that solve real-world problems. Whether you're a developer, investor, or potential partner, we'd love to hear from you.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center space-y-4">
            <div className="flex items-center justify-center space-x-3">
              ...
              <span className="font-space-grotesk font-bold text-xl">Develix Projects</span>
            </div>
            <p className="text-primary-foreground/80 max-w-2xl mx-auto">
              Building the future of technology with innovative solutions that solve real-world problems across Africa and beyond.
            </p>

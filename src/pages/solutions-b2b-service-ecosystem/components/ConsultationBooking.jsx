...
const ConsultationBooking = () => {
  ...
  const handleSubmit = (e) => {
    ...
    console.log('Consultation booking:', { ...formData, selectedDate, selectedTime });
  };
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Book a founder-level technical discussion to explore how AI and blockchain 
            can transform your business. Free 60-minute consultation with our technical team.
          </p>
        </div>
                      ...
                      <button
                        ...
                        className={`p-3 rounded-lg border text-center brand-transition ${
                          selectedTime === slot?.value
                            ? 'border-secondary bg-secondary/10 text-secondary' :'border-border hover:border-secondary/50 hover:bg-secondary/5'
                        }`}
                      >
                        {slot?.label}
                      </button>
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={index} className="flex items-center">
                    <Icon name="Check" size={20} className="text-accent mr-3 flex-shrink-0" />
          ...
          <div className="bg-card rounded-xl p-8 border border-border brand-shadow-card">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <p className="text-xs text-muted-foreground text-center">
                By booking, you agree to our terms of service. We'll send a calendar invite 
                with meeting details to your email.
              </p>
            </form>
          </div>
        </div>

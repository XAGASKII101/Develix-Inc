  ...
  const partnerCategories = [
    {
      ...
      description: "Seamless integration with leading African payment processors",
      partners: [
        {
          name: "Paystack",
          logo: "https://images.unsplash.com/photo-1611224923853-80b023f02d71?w=120&h=60&fit=crop",
          description: "Direct API integration for card payments, bank transfers, and mobile money",
          features: ["Real-time payments", "Fraud protection", "Multi-currency support"],
          integrationTime: "2-3 days"
        },
        {
          name: "Flutterwave",
          logo: "https://images.unsplash.com/photo-1611224923853-80b023f02d71?w=120&h=60&fit=crop",
          description: "Comprehensive payment solutions across Africa and globally",
          features: ["Cross-border payments", "Recurring billing", "Payment analytics"],
      ...
      partners: [
        {
          ...
          description: "Comprehensive cloud computing platform with global reach",
        ...
        },
        {
          ...
          description: "Enterprise-focused cloud solutions with hybrid capabilities",
    ...
    },
    {
      ...
      description: "Integration with leading blockchain platforms and protocols",
      partners: [
        {
          name: "Polygon",
          logo: "https://images.unsplash.com/photo-1639762681485-074b7f938ba0?w=120&h=60&fit=crop",
          description: "Ethereum-compatible blockchain with low transaction costs",
        ...
        },
        {
          ...
          features: ["High throughput", "EVM compatible", "Cross-chain bridges"],
          integrationTime: "1-2 weeks"
        },
        {
          name: "Ethereum",
    ...
    },
    {
      ...
      partners: [
        ...
        },
        {
          ...
          features: ["ERP integration", "Financial data sync", "Workflow automation"],
  ...
  const integrationProcess = [
    {
      ...
      description: "We analyze your existing systems and plan the integration strategy",
      duration: "1-2 days",
      icon: "Search"
    },
    {
      ...
      description: "Configure APIs and establish secure connections with partner systems",
      duration: "2-5 days",
      icon: "Settings"
    },
    {
      ...
      description: "Comprehensive testing to ensure seamless data flow and functionality",
      duration: "1-3 days",
      icon: "CheckCircle"
    },
    {
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Connect with leading platforms and services through our pre-built integrations. 
            From payment gateways to enterprise software, we ensure smooth data flow.
          </p>
        </div>
                    ...
                    <div className="flex items-center mb-6">
                      ...
                      <div>
                        ...
                        <div className="flex items-center mt-1">
                          <Icon name="Clock" size={14} className="text-accent mr-1" />
        ...
        <div className="mt-20 pt-16 border-t border-border">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              A streamlined 4-step process ensuring smooth integration with minimal disruption 
            ...
            {integrationProcess?.map((process, index) => (
              <div key={index} className="text-center group">
                ...
                <div className="inline-flex items-center px-3 py-1 bg-accent/10 rounded-full">
                  <Icon name="Clock" size={14} className="text-accent mr-1" />
                  <span className="text-xs font-medium text-accent">{process.duration}</span>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="text-center mt-16 pt-12 border-t border-border">
          ...
          <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
            Don't see your platform listed? We can build custom integrations for any system 
            or service your business relies on.
          </p>

...
import { slideIn, fadeInUp } from "../../../lib/animations";
...
const IndustrySolutions = () => {
  ...
  const industries = {
    fintech: {
      ...
      description:
        "Revolutionary financial technology solutions for Nigerian banks and fintech companies",
      challenges: [
      ...
      solutions: [
        {
          ...
          description:
            "Real-time transaction monitoring with 99.7% accuracy in fraud detection",
        ...
        },
        {
          ...
          description:
            "Automated customer verification with biometric integration",
        ...
        },
        {
          ...
          description:
            "Cross-border payment infrastructure with instant settlements",
        ...
        },
        {
          ...
          description:
            "Mobile-first banking solutions for underserved communities",
    ...
    agriculture: {
      ...
      description:
        "Smart agriculture solutions leveraging IoT, blockchain, and AI for Nigerian farmers",
      challenges: [
      ...
      solutions: [
        {
          ...
          description:
            "Farm-to-market tracking system ensuring product authenticity",
        ...
        },
        {
          ...
          description:
            "Smart sensors for soil moisture, temperature, and crop health monitoring",
        ...
        },
        {
          ...
          description:
            "AI-powered price prediction and market matching platform",
        ...
        },
        {
          ...
          description:
            "Computer vision for automated quality grading and certification",
    ...
    healthcare: {
      ...
      description:
        "Digital health solutions improving healthcare accessibility across Nigeria",
      challenges: [
      ...
      solutions: [
        {
          ...
          description:
            "Video consultation platform connecting patients with specialists",
        ...
        },
        {
          ...
          description:
            "Machine learning models for preliminary diagnosis and triage",
    ...
    ecommerce: {
      ...
      description:
        "Next-generation e-commerce solutions for Nigerian online retailers",
      challenges: [
      ...
      solutions: [
        {
          ...
          description:
            "Personalized product recommendations increasing conversion rates",
        ...
        },
        {
          ...
          description:
            "Predictive analytics for optimal stock levels and demand forecasting",
        ...
        },
        {
          ...
          description:
            "Integrated payment solutions supporting all Nigerian payment methods",
        ...
        },
        {
          ...
          description:
            "Route optimization and delivery tracking for last-mile efficiency",
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Industry-specific solutions addressing unique challenges in Nigerian
            markets. From fintech to agriculture, we understand local needs and
            global standards.
          </p>
        </motion.div>
        ...
        <div className="space-y-12">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="bg-card rounded-xl p-6 border border-border">
                ...
                <div className="space-y-3">
                  {industries?.[activeIndustry]?.challenges?.map(
                    (challenge, index) => (
                      <div key={index} className="flex items-start">
                        <Icon
                          name="Minus"
                          size={16}
                          className="text-muted-foreground mr-3 mt-1 flex-shrink-0"
                        />
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {industries?.[activeIndustry]?.integrations?.map(
                    (integration, index) => (
                      <span
                        key={index}
            ...
            <motion.div
              ...
              whileInView="show"
              viewport={{ once: true, amount: 0.2 }}
              className="relative overflow-hidden rounded-xl brand-shadow-card"
            >
              <Image
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            {industries?.[activeIndustry]?.solutions?.map((solution, index) => (
              <motion.div
                key={index}
                variants={fadeInUp(index * 0.2)} // staggered animation
                initial="hidden"
                whileInView="show"
                viewport={{ once: true, amount: 0.2 }}

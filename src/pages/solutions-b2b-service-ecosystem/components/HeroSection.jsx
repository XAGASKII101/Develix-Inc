  ...
  return (
    <section className="relative from-primary via-primary/95 to-primary/90 text-primary overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-40">
        ...
        <div className="absolute top-40 left-1/2 w-32 h-32 border border-secondary rounded-full"></div>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {capabilities?.map((capability, index) => (
                  <SlideUp key={capability?.id} delay={index * 0.15}>
                    <div className="group bg-primary-foreground/10 backdrop-blur-sm rounded-xl p-6 border border-primary-foreground/20 hover:border-secondary/50 brand-transition cursor-pointer brand-hover-lift">

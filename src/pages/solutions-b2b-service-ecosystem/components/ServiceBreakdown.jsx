...
const ServiceBreakdown = () => {
  ...
  const services = {
    ai: {
      ...
      description:
        "Custom artificial intelligence solutions tailored for Nigerian enterprises",
      applications: [
        {
          title: "Banking Chatbots",
          description:
            "AI-powered customer service for Nigerian banks with local language support",
        ...
        },
        {
          ...
          description:
            "Business intelligence and forecasting for retail chains",
    ...
    blockchain: {
      ...
      description:
        "Secure, transparent blockchain solutions for supply chain and finance",
      applications: [
        {
          title: "Agricultural Supply Chain",
          description:
            "Farm-to-market traceability for Nigerian agricultural products",
        ...
        },
        {
          ...
          description:
            "Cross-border payment infrastructure with Paystack integration",
      ...
      applications: [
        {
          ...
          description:
            "Full-stack e-commerce solutions with local payment integration",
        ...
        },
        {
          ...
          description:
            "Patient management systems for Nigerian healthcare providers",
        ...
        },
        {
          ...
          description:
            "Learning management systems for African educational institutions",
    ...
    transformation: {
      ...
      description:
        "Complete digital ecosystem overhaul for traditional businesses",
      applications: [
        {
          title: "Process Automation",
          description:
            "Workflow automation for manufacturing and logistics companies",
        ...
        },
        {
          ...
          description:
            "Secure migration to cloud infrastructure with local data centers",
        ...
        <FadeIn delay={0.1}>
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl lg:text-5xl font-space-grotesk font-bold text-foreground mb-6">
              Real-World Applications <br /> Delivering Measurable Results
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Explore detailed breakdowns of our services with actual project
              outcomes, technologies used, and measurable business impact for
        ...
        <FadeIn delay={0.2}>
          <div className="flex flex-wrap justify-center gap-4 mb-12">
            {serviceKeys?.map((service, index) => (
              <SlideUp key={service?.key} delay={index * 0.1}>
                <button
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {services?.[activeService]?.applications?.map((app, index) => (
              <SlideUp key={index} delay={index * 0.15}>
                <div className="bg-card rounded-xl p-8 border border-border brand-shadow-card hover:border-primary/20 brand-transition group brand-hover-lift">

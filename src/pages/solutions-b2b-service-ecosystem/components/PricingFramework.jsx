...
const PricingFramework = () => {
  ...
  const pricingPlans = [
    ...
    },
    {
      ...
      timeline: "8-12 weeks",
      bestFor:
        "Growing companies, established businesses, feature-rich applications",
    },
    {
      id: "enterprise",
      ...
      bestFor:
        "Large enterprises, complex systems, mission-critical applications",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            ...
            helps you plan your technology investment with confidence.
          </p>
        </div>
                    ...
                    {plan?.limitations?.map((limitation, index) => (
                      <div key={index} className="flex items-start">
                        <Icon
                          name="Minus"
                          size={14}
                          className="text-secondary mr-2 mt-1 flex-shrink-0"
                        />
                        <span className="text-sm text-muted-foreground">
                          {limitation}
                        </span>
        ...
        <div className="mb-16">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Extend your project with these optional services for enhanced
              value and support.
            </p>
          </div>
        ...
        <div className="mb-16">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Understanding what influences project costs helps you make
              informed decisions about your technology investment.
            </p>
          </div>
        ...
        >
          ...
          <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
            ...
            and get a detailed quote tailored to your specific needs.
          </p>

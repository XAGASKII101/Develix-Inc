      ...
      features: [
        {
          ...
          description:
            "Direct integration with Paystack, Flutterwave, and international payment processors",
        ...
        },
        {
          name: "Banking APIs",
          description:
            "Secure connections to Nigerian banks for account verification and transactions",
        ...
        },
        {
          ...
          description:
            "Scalable API development with comprehensive documentation and testing",
    ...
    security: {
      ...
      features: [
        ...
        },
        {
          ...
          description:
            "Biometric, SMS, and hardware token authentication options",
    ...
    monitoring: {
      ...
      features: [
        ...
        },
        {
          ...
          description:
            "Tailored analytics dashboards for business intelligence",
        ...
        },
        {
          ...
          description:
            "Scheduled reports with actionable insights and recommendations",
  ...
  return (
    <section className="py-20 bg-background">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          <div className="inline-flex items-center px-4 py-2 bg-secondary/10 rounded-full text-sm font-medium mb-6">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Robust technical infrastructure designed for enterprise
            requirements. From API integrations to security protocols that CTOs
            trust.
          </p>
        </motion.div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                {" "}
                AWS, Google Cloud, and Azure certified infrastructure with 99.9%
                uptime SLA{" "}
              </p>{" "}
            </div>{" "}
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                {" "}
                Modern tech stack including React, Node.js, Python, and
            ...
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                {" "}
                Dedicated technical support team with 24/7 availability and
        ...
        >
          ...
          <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
            Get detailed technical specifications, API documentation, and
            architecture diagrams for your evaluation process.
          </p>

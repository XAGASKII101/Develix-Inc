  ...
  const caseStudies = [
    {
      ...
      challenge:
        "High volume of customer inquiries overwhelming support staff, leading to long wait times and customer dissatisfaction.",
      solution:
        "Deployed multilingual AI chatbot with natural language processing capabilities, integrated with core banking systems.",
      results: {
      ...
      testimonial:
        "Develix transformed our customer service operations. The AI chatbot handles 85% of inquiries automatically while maintaining our high service standards.",
    ...
    },
    {
      ...
      challenge:
        "Lack of transparency in supply chain leading to quality control issues and inefficient inventory management.",
      solution:
        "Implemented blockchain-based supply chain tracking system with IoT sensors and mobile applications for farmers and distributors.",
      results: {
        primary: "40% reduction in food waste",
        secondary: [
          "100% product traceability",
          "30% improvement in quality control",
          "₦2.1B inventory optimization",
        ],
      ...
      testimonial:
        "The blockchain solution provided unprecedented visibility into our supply chain. We can now track every product from farm to consumer.",
    ...
    },
    {
      ...
      challenge:
        "Rising fraud rates affecting customer trust and causing significant financial losses in online transactions.",
      solution:
        "Developed real-time fraud detection system using machine learning algorithms and behavioral analysis.",
      results: {
        primary: "99.7% fraud detection accuracy",
        secondary: [
          "₦500M+ fraud prevented annually",
      ...
      testimonial:
        "Develix's fraud detection system has been game-changing. We've prevented millions in losses while improving customer experience.",
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          <motion.h2
            ...
            className="text-3xl lg:text-5xl font-space-grotesk font-bold text-foreground mb-6"
          >
            Proven Results for
          ...
          >
            Real case studies showcasing measurable outcomes, cost savings, and
            efficiency gains achieved by our enterprise clients across various
            industries.
          </motion.p>
        </motion.div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {study?.technologies?.map((tech, techIndex) => (
                      <span
                        key={techIndex}
                        className="px-3 py-1 text-para text-sm rounded-full font-medium"
                      >
                        {tech}
                      </span>
                    ))}
        ...
        >
          ...
          <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
            Join these leading Nigerian enterprises in leveraging AI and
            blockchain technology to drive measurable business outcomes.
          </p>

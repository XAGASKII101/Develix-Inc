...
const OfficeInfo = () => {
  ...
  const socialLinks = [
    { icon: 'Twitter', href: 'https://twitter.com/develixtech', label: 'Twitter' },
    { icon: 'Linkedin', href: 'https://linkedin.com/company/develix', label: 'LinkedIn' },
    { icon: 'Github', href: 'https://github.com/develix', label: 'GitHub' },
    { icon: 'Youtube', href: 'https://youtube.com/@develixtech', label: 'YouTube' }
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <p className="text-lg text-muted-foreground mb-8">
              Located in the heart of Lagos tech ecosystem, our office is open for meetings, 
              consultations, and collaborative sessions. We're proud to be building the future 
              of African technology from Nigeria.
            </p>
                ...
                >
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <h4 className="font-medium text-foreground text-sm">{method?.title}</h4>
                ...
                <div className="absolute top-4 left-4 right-4">
                  <div className="bg-background/95 backdrop-blur-sm rounded-lg p-4 brand-shadow-card">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <h4 className="font-semibold text-foreground text-sm">Develix HQ</h4>
              ...
              <div className="p-6">
                <div className="flex flex-col sm:flex-row gap-3">
                  <Button
                    ...
                    iconPosition="left"
                    className="flex-1"
                    onClick={() => window.open(`https://www.google.com/maps?q=${officeDetails?.coordinates}`, '_blank')}
                  >
                    Get Directions
                  </Button>
                  <Button

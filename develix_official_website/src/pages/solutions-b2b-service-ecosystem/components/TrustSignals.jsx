  ...
  const certifications = [
    {
      ...
      description: "Officially registered with Corporate Affairs Commission (CAC)",
      number: "RC 1234567",
      icon: "Building",
      verified: true
    },
    ...
    {
      name: "GDPR Compliant",
      description: "General Data Protection Regulation compliance for EU clients",
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Our track record speaks for itself. From certifications to client testimonials, 
            see why enterprises trust Develix with their most critical technology projects.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-4 gap-8 mb-16">
          {companyMetrics?.map((metric, index) => (
            ...
            >
              ...
              <div className="font-space-grotesk font-bold text-foreground mb-2">{metric?.label}</div>
                    ...
                    <div className="flex items-center mb-2">
                      ...
                      {cert?.verified && (
                        <div className="flex items-center px-2 py-1 bg-accent/10 rounded-full">
                          <Icon name="CheckCircle" size={14} className="text-accent mr-1" />
        ...
        <div className="mb-16">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Hear directly from our enterprise clients about their experience working with Develix 
              ...
              >
                ...
                <div className="bg-surface rounded-lg p-4 space-y-2">
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="font-medium text-foreground">{testimonial?.projectValue}</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-muted-foreground">Completed:</span>
                    <span className="font-medium text-foreground">{testimonial?.completionDate}</span>
                  </div>
                </div>
              </div>
            ))}
        ...
        <div className="mb-16">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              ...
              to protect your sensitive information and business operations.
            </p>
          </div>
              ...
              >
                <div className="flex items-start space-x-4">
                  <div className="w-14 h-14 bg-secondary/10 rounded-xl flex items-center justify-center flex-shrink-0">
                    <Icon name={measure?.icon} size={28} className="text-secondary" />
                  </div>
                  <div className="flex-1">
        ...
        <div className="mb-16">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              ...
              in Nigerian technology development.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {awards?.map((award, index) => (
              ...
              >
                ...
                <div className="text-sm text-muted-foreground mb-2">{award?.category}</div>
                <div className="text-sm font-medium text-primary mb-1">{award?.organization}</div>
        ...
        <div className="text-center bg-gradient-to-br from-primary/5 via-secondary/5 to-accent/5 rounded-xl p-12">
          ...
          <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
            Experience the same level of excellence and results that have made us the trusted 
            technology partner for Nigeria's leading enterprises.
          </p>
